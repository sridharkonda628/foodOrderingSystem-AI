    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-xl border border-slate-200">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-black text-slate-900">Sign in to CraveAI</h2>
          <p className="text-xs text-slate-500 mt-1">Access natural AI food ordering and real-time order tracking.</p>
        </div>

        <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4 mb-6">
          <span className="text-[11px] font-bold text-orange-900 uppercase tracking-wider block mb-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="bg-white hover:bg-orange-100 text-slate-800 text-xs font-bold py-2 px-3 rounded-xl border border-orange-200 shadow-xs flex items-center justify-center gap-1.5 cursor-pointer"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-sm focus:ring-2 focus:ring-orange-500 focus:outline-hidden"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 rounded-xl shadow-md transition cursor-pointer"
          >
