        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2 rounded-xl border border-slate-300 text-sm focus:ring-2 focus:ring-orange-500 focus:outline-hidden bg-white"
              >
                {categories.map((c) => (
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
            ...
            <button
              ...
              className="px-5 py-2 text-sm font-bold bg-orange-600 hover:bg-orange-700 text-white rounded-xl shadow-xs"
            >
